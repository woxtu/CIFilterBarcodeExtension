...
public class CIEAN13BarcodeGenerator: CIFilter {
  ...
  /// The message to encode in the EAN-13 barcode.
  ...
  public override var outputImage: CIImage? {
    guard
      ...
      let barcodePattern = EAN13.encode(message)
    else {
      return nil
    }
...
class CIEAN13BarcodeGeneratorConstructor: CIFilterConstructor {
