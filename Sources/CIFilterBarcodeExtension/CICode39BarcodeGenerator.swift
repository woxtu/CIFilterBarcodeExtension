...
public class CICode39BarcodeGenerator: CIFilter {
  ...
  /// The message to encode in the Code 39 barcode.
  ...
  public override var outputImage: CIImage? {
    guard
      ...
      let barcodePattern = Code39.encode(message)
    else {
      return nil
    }
...
class CICode39BarcodeGeneratorConstructor: CIFilterConstructor {
