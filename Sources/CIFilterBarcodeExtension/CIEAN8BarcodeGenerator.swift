...
public class CIEAN8BarcodeGenerator: CIFilter {
  ...
  /// The message to encode in the EAN-8 barcode.
  ...
  public override var outputImage: CIImage? {
    guard
      ...
      let barcodePattern = EAN8.encode(message)
    else {
      return nil
    }
...
class CIEAN8BarcodeGeneratorConstructor: CIFilterConstructor {
